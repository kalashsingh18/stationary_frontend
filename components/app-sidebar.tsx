...
const managementNav = [
  { title: "Schools", href: "/dashboard/schools", icon: GraduationCap },
...
const operationsNav = [
  ...
  { title: "Invoices (POS)", href: "/dashboard/invoices", icon: Receipt },
]
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/dashboard">
                ...
                <div className="flex flex-col gap-0.5 leading-none">
                  <span className="font-semibold">StationeryPro</span>
